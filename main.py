# Перед началом импортируйте зависимости командой pip install -r requirements.txt
# В файле config.py заполните api_id и api_hash
# В конфиге есть параметр send_user
# Если он равен True, то после импорта контакт будет добавлен в Избранное
# Так вы сможете перейти на него и посмотреть профиль пользователя
# Сделано для канала https://t.me/slivmenss
